    ...
    <main>
        ...
        <section class="carnets-hero">
            <div class="container" style="max-width: 900px; position: relative; z-index: 5;">
                <span style="color: #9eff42; font-weight: 700; font-size: 0.85rem; letter-spacing: 0.12em; text-transform: uppercase;">Identificación Institucional de Autor</span>
                <h1 style="font-family: var(--font-heading); font-size: 3.2rem; font-weight: 400; margin-top: 15px; margin-bottom: 20px; color: white; line-height: 1.15;">Credenciales & Carnets de Alta Fidelidad</h1>
                <p style="font-size: 1.15rem; color: rgba(255, 255, 255, 0.88); line-height: 1.6; margin: 0 auto;">
                    No imprimimos plástico común descartable. Fabricamos credenciales en PVC laminado de alta densidad con resolución fotográfica, laminación protectora y acabados de seguridad. Sin mínimos masivos forzados: personalizamos el número exacto de credenciales que tu equipo necesita.
                </p>
            </div>
        </section>
