                        ...
                        <div class="footer-contact-item" style="font-size: 1rem; align-items: flex-start;">
                            ...
                            <div>
                                ...
                                <?php foreach ($all_phones as $idx => $p): ?>
                                    <a href="<?php echo formatWhatsAppUrl($p, 'Hola Cardnetec, deseo realizar una consulta técnica o cotización.'); ?>" target="_blank" rel="noopener noreferrer" style="display: inline-block; font-size: 0.95rem; color: var(--primary); text-decoration: none; margin-top: 4px; font-weight: 500; transition: opacity 0.2s;" onmouseover="this.style.opacity='0.8'" onmouseout="this.style.opacity='1'" title="Chatear por WhatsApp">
