...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const injectGlobalModals = () => {
        ...
        const bottomBarHtml = `
            <div class="mobile-bottom-bar" style="background: rgba(255,255,255,0.96); backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); border-top: 1px solid var(--border); box-shadow: 0 -2px 8px rgba(0,0,0,0.04); padding: 6px 12px; display: grid; grid-template-columns: 1fr 1.1fr; gap: 8px; position: fixed; bottom: 0; left: 0; width: 100%; z-index: 9999;">
                <a href="https://wa.me/593900000000" class="btn btn-secondary" target="_blank" rel="noopener" style="padding: 7px 10px; font-size: 0.75rem; font-weight: 600; display: flex; align-items: center; justify-content: center; gap: 6px; border: 1px solid var(--border); border-radius: 6px; background: white; color: var(--dark); text-transform: none; text-decoration: none; transition: all 0.2s ease;">
                ...
                <button class="btn btn-primary toggle-quote-drawer-btn" style="padding: 7px 10px; font-size: 0.75rem; font-weight: 600; display: flex; align-items: center; justify-content: center; gap: 6px; border-radius: 6px; background: var(--primary); border: none; color: white; text-transform: none; cursor: pointer; transition: all 0.2s ease;">
